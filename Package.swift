...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "SextantKit", url: "https://github.com/KittyMac/Sextant.git", .branch("main")),
    ...
    targets: [
        ...
        .target( name: "DGCSHInspection",
            dependencies: ["DGCCoreLibrary", "SwiftPath", "SextantKit", "SWCompression", "Alamofire", "JOSESwift"]),
